...
<head>
    ...
    <body class="nav-md">
        ...
        abstract class AbstractClass{
            abstract protected function getvalueTest();
            abstract protected function prefixValue($prefix);

            public function printOUt(){
                print $this->getvalueTest();
            }
        }
        class Test1 extends AbstractClass{
            protected function getvalueTest(){
                return "chuỗi gì đấy";
            }
            protected  function prefixValue( $test)
            {
            return "test abstract".$test;
            }
        }
        class test2 extends AbstractClass{
            protected function getvalueTest(){
                return "hahahahahahahhhaaa của test 2";
            }
            protected  function prefixValue( $test)
            {
            return "Test xem nó là của test 2 mà".$test;
            }
        }
        $duc=new Test1();
        $duc->printOUt();
        $Obj2=new test2();
        $Obj2->printOUt();
        $AnonymounsFunction=function($name){
            echo "nguyễn minh".$name;

        };
        $AnonymounsFunction("hacker");

        $AnonymounsFunction("hacker bug");
        $Mess="hello";
            ...
            <div class="main_container">
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        ...
                        <br>
                      <div id="Infomation" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <div class="editerLocationImg"> <img src="./assets/images/<?php echo $row["Avatar"] ?>" alt=".." class="img-circle profile_img" style="height:185px"></div>
        ...
        <span class="input input--hoshi">
                ...
                <span class="input input--hoshi">
					<input class='datetime' name='BirthDay' value=<?php echo $rows['BirthDay'] ?>  class="input__field input__field--hoshi" type="text" id="input-4">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                ...
                                <ul class="nav side-menu" style="">
                                    ...
                                    <li class=""><a><i class="fa fa-edit"></i>Post <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="display: none;">
                                            <li><a class="PostConfessions" href="#">Post Confessions</a></li>
                                              ...
                                              <li><a href="#" class="CheckPost"> Check Post(Admin,Editer)</a></li>
                                        </ul>
                                    </li>
                                    <li><a><i class="fa fa-desktop"></i>Infomation User<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="">
                                            ...
                                            <li><a class="GrantRight" href="#">Grant Rights Accout(Admin)</a></li>
                                            <li><a class="managerAllPost" href="#">Manager All Post(Admin)</a></li>
                                           
                                        </ul>
                                    </li>
                                    <li><a><i class="fa fa-table"></i> Config <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="">
                                        <li><a class="Config" href="#">Config Project</a></li>
                ...
                <div class="hides ConfigView">
                <span class="input input--haruki">
	
               
                        <?php 
                        include "./core/application/view/includeView/config.php";
                    ...
                    <?php include "./core/application/view/includeView/newConfresssion.php"; ?>
                    ...
                    <div class="hides InfomationUser">
                        ...
                        <?php 
                        include "./core/application/view/includeView/InformationUser.php";
                         ?>
                    </div>
                    <!--end  feature InfomationUser -->
                    <div class="hides GrantUser">
                  
                        <?php 
                        include "./core/application/view/includeView/GrantUser.php";
                         ?>
                    </div>
                            <!-- end Grant User -->
                    ...
                    include "./core/application/view/includeView/HistoryPost.php";
                    ?>
                    
                    
                    </div>
                    <!--end  feature postHistory -->
                    <div class="hides CheckPostContainer">
                    <?php 
                    
                    include "./core/application/view/includeView/CheckPost.php";
                    ?>
                    ...
                    <div class="hides PostConfession ">
                       ...
                       ?>
                    <div class="hides managerAllPost ">
                       <?php 
                       include "./core/application/view/includeView/ManagerAllPost.php";
                       ?>
